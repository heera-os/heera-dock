/*
 * Copyright (C) 2020 ~ 2021 HeeraOS Team.
 *
    ...
    , m_resizeAnimation(new QVariantAnimation(this))
{
    ...
    qmlRegisterType<Brightness>("Heera.Dock", 1, 0, "Brightness");
    qmlRegisterType<ControlCenterDialog>("Heera.Dock", 1, 0, "ControlCenterDialog");
    qmlRegisterType<StatusNotifierModel>("Heera.Dock", 1, 0, "StatusNotifierModel");
